...
//PS2手柄、蓝牙APP、航模手柄、CAN通信、串口1、串口5、通信控制标志位。这5个标志位默认都为0，代表串口3控制模式
u8 PS2_ON_Flag=0, APP_ON_Flag=0, Remote_ON_Flag=0, CAN_ON_Flag=0, Usart1_ON_Flag=0, Usart5_ON_Flag; 
